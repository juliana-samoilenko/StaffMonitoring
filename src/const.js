...
export const EMPLOYEE_TRACKS = [
  new EmployeeTrack ({ id: 1, name: 1, points: points1, isEmpty: true }),
  new EmployeeTrack ({ id: 2, name: 2, points: points2, isEmpty: false }),
  new EmployeeTrack ({ id: 3, name: 3, points: points3, isEmpty: false }),
  new EmployeeTrack ({ id: 4, name: 4, points: points4, isEmpty: true }),
  new EmployeeTrack ({ id: 5, name: 5, points: points5, isEmpty: true })
];
