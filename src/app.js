...
const employee1 = new Employee({
  id: 1, name: 'Петров С.М.', xCurrent: 50, yCurrent: 50, radius: 15, color: '#3A19A4', track: track1}, two );
employees.push(employee1);

const track2 = new EmployeeTrack( { id: 1, points: [{x: 200, y: 200}, {x: 200, y: 250}, {x: 250, y: 250}, {x: 250, y: 200}]} );
const employee2 = new Employee({
  id: 2, name: 'Петров С.М.', xCurrent: 200, yCurrent: 200, radius: 15, color: '#3A19A4', track: track2 }, two );
employees.push(employee2);

const track3 = new EmployeeTrack( { id: 1, points: [{x: 400, y: 400}, {x: 500, y: 500}, {x: 300, y: 500}]} );
const employee3 = new Employee({
  id: 3, name: 'Кожемяка В.С.', xCurrent: 500, yCurrent: 500, radius: 15, color: '#3A19A4', track: track3}, two );
