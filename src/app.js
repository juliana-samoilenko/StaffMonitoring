...
const employeeEntity1 = new EmployeeEntity({ id: 1, name: 'Петров С.М.', position: 'engineer', zones: [1, 2] });
...
const employeeEntity2 = new EmployeeEntity({ id: 2, name: 'Щербаков Д.Д.', position: 'working', zones: [2, 4] });
...
const employeeEntity3 = new EmployeeEntity({ id: 3, name: 'Пугало Р.К.', position: 'programmer', zones: [1, 3, 4] });
